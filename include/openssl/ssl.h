...
#define SSL_CTX_set1_session_id_context SSL_CTX_set_session_id_context
__owur int SSL_CTX_set_session_id_context(SSL_CTX *ctx,
                                          const unsigned char *sid_ctx,
                                          unsigned int sid_ctx_len);
__owur int SSL_CTX_get0_session_id_context(const SSL_CTX *ctx,
                                           const unsigned char **sid_ctx,
                                           size_t *sid_ctx_len);
...
#define SSL_set1_session_id_context SSL_set_session_id_context
__owur int SSL_set_session_id_context(SSL *ssl, const unsigned char *sid_ctx,
                                      unsigned int sid_ctx_len);
__owur int SSL_get0_session_id_context(const SSL *ssl,
                                       const unsigned char **sid_ctx,
                                       size_t *sid_ctx_len);
...
__owur long SSL_SESSION_get_verify_result(const SSL_SESSION *ss);
