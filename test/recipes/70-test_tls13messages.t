...
SKIP: {
    ...
    $proxy->clear();
    $proxy->clientflags("-no_cert_comp -status");
    $proxy->start();
    checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
                   checkhandshake::DEFAULT_EXTENSIONS
                   | checkhandshake::STATUS_REQUEST_CLI_EXTENSION,
    ...
    $proxy->clear();
    $proxy->clientflags("-no_cert_comp");
    $proxy->serverflags("-no_cert_comp -status_file "
    ...
    $proxy->clear();
    $proxy->clientflags("-no_cert_comp -status -enable_pha -cert "
                        .srctop_file("apps", "server.pem"));
    $proxy->serverflags("-no_cert_comp -Verify 5 -status_file "
                        .srctop_file("test", "recipes", "ocsp-response.der"));
    $proxy->start();
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -enable_pha -cert ".srctop_file("apps", "server.pem"));
$proxy->serverflags("-no_cert_comp -Verify 5");
$proxy->start();
checkhandshake($proxy, checkhandshake::CLIENT_AUTH_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS |
               checkhandshake::POST_HANDSHAKE_AUTH_CLI_EXTENSION,
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -noservername");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
               & ~checkhandshake::SERVER_NAME_CLI_EXTENSION,
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -noservername");
$proxy->serverflags("-no_cert_comp -servername testhost");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
               & ~checkhandshake::SERVER_NAME_CLI_EXTENSION,
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -servername testhost");
$proxy->serverflags("-no_cert_comp -servername testhost");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -alpn test");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
               | checkhandshake::ALPN_CLI_EXTENSION,
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp");
$proxy->serverflags("-no_cert_comp -alpn test");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS,
...
SKIP: {
    ...
    $proxy->clientflags("-no_cert_comp -ct");
    $proxy->serverflags("-no_cert_comp -status_file "
                        .srctop_file("test", "recipes", "ocsp-response.der")
...
$proxy->clear();
$proxy->clientflags("-no_cert_comp -curves P-256");
$proxy->start();
checkhandshake($proxy, checkhandshake::DEFAULT_HANDSHAKE,
               checkhandshake::DEFAULT_EXTENSIONS
               | checkhandshake::SUPPORTED_GROUPS_SRV_EXTENSION,
